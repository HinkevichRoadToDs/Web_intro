...
$workExp = [
    [
        ...
        'period_end' => 'Current time',
        'description' => 'Уникальный текст, отличающийся от других.',
    ],
    [
        'position' => 'Cryptoenthusiast(hamster)/Student',
        'period_start' => 'June 2021',
        'period_end' => 'Aug 2022',
        'description' => 'А здесь увлекательный рассказ про становление юного криптоинвестора. Этот путь был наполнен деген-мувами и потерей депозита, покупкой на верхах и fud`ом.',
    ],
    [
        'position' => 'Steam-trader/Student',
        'period_start' => 'Sep 2019',
        'period_end' => 'June 2021',
        'description' => 'Долго рассказывать.',
    ],
];
?>
<!DOCTYPE html>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          ?>
            ...
            <?= $workExp[$i]['period_start'];?> 
            - 
            <?php if ($i == 0) {?>
            <span class="w3-tag w3-teal w3-round">Current</span></h6>
            <?php }
            	  else {  
            	echo $workExp[$i]['period_end']; ?> </h6><?php }?>
